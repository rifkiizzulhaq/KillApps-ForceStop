...
import { BatteryOptimizationModal } from "../../../src/components/modals/BatteryOptimizationModal";
...
describe("BatteryOptimizationModal", () => {
	it("renders correctly", () => {
		...
		renderer.act(() => {
			tree = renderer.create(
				React.createElement(BatteryOptimizationModal as any, props),
			);
		});
